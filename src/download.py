...
def main(cfg: DictConfig) -> None:
    ...
    downloader = Downloader(download_params['entity'], download_params['project'])
    ...
    folder = os.path.join(*download_params['folder'])
    ...
    try:
        ...
        downloader.save_summary(runs_to_process, folder, download_params['project'])
    except Exception as e:
        logger.info('Could not save summary:', e)
